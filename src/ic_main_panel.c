...
static GtkTreeModel *contact_tree_model_new(GList *contactList) {
	...
	pixbuf = gdk_pixbuf_new_from_file_at_scale(RESDIR"images/photo/photo.png", 40, 40, TRUE, NULL);
...
GtkWidget *ic_main_panel_new(UserInfo *user) {
	...
	photoPixbuf = gdk_pixbuf_new_from_file_at_scale(RESDIR"images/photo/photo.png", 60, 60, TRUE, NULL);
